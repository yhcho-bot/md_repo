...
void keyboardCallBack(const geometry_msgs::Twist& keyVel)   //from turtlebot3_teleop_key node
{
    ...
    if(Md.nAngleResolution)
        Md.sCmdAngularVel = keyVel.angular.z * 10.0*3.141592/180.0;// 0.1 deg/s
    else
        Md.sCmdAngularVel = keyVel.angular.z * 3.141592/180.0;// 1 deg/s
}
///////////////////////////////////////////////////////////////////////////////////////////////
...
int main(int argc, char** argv)	
{
    ...
    ros::Rate r(150);                                                                      //Set the loop period -> 50ms.
